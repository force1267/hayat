...
janelaPopUp.abre = function(id, classes, titulo, corpo, functionCancelar, functionEnviar, textoCancelar, textoEnviar){
    var cancelar = (textoCancelar !== undefined)? textoCancelar: 'تایید';
...
janelaPopUp.fecha = function(id){
    if(id !== undefined){
        $("#" + id).removeClass("popUpEntrada").addClass("popUpSaida"); 
            $("#popFundo_" + id).fadeOut(0, function(){
                $("#popFundo_" + id).remove();
...
// });
// janelaPopUp.abre( "example", 'p blue alert',  'Example' ,  'chosse a configuration and click the color!');
// setTimeout(function(){janelaPopUp.fecha('example');}, 2001);